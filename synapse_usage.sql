...
// Figure 5 Number of unique Synapse account holders 2012-2024
with cte as (
    select
...
SELECT
    count(distinct adtr_snapshot_in_time.id) as total_entities,
...
join
    ...
    on file_latest.id = adtr_snapshot_in_time.file_handle_id
WHERE
